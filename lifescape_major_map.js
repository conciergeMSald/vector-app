/**
 * VECTOR Lifescape — MAJOR_MAP
 * Business Administration / Economics (NAICS 52 vs 94) renamed 2026-07-25.
 * ALL 11 original pre-existing MAJOR_MAP duplicate pairs now fully resolved.
 */
const MAJOR_MAP = {
  "11": [
    {
  ...
  "44": [
    {
      "major_label": "Retail & E-Commerce Marketing",
      "riasec_affinity": [
        "E",
        "A",
        "S"
    ...
    {
      "major_label": "Supply Chain Management (Retail & Merchandising Track)",
      "riasec_affinity": [
        "C",
        "R",
        "E"
      ...
      "world_alignment": "Systems",
      "cc_transfer_friendly": true,
      "emerging_role": "Retail Supply Chain & Merchandising Planner — the professional who manages the sourcing, allocation, and inventory-flow decisions that determine whether the right product is on the right shelf, physical or digital, at the right time, for a retail organization specifically rather than a third-party logistics or manufacturing operation. Target, Walmart, and Nordstrom all run merchandising-and-supply-chain hybrid tracks that blend buying, demand forecasting, and vendor management — a distinct discipline from the carrier-and-warehouse-operations side of supply chain most people picture first.",
      "deployment_contexts": [
        {
  ...
  "51": [
    ...
    },
    {
      ...
      "program_keywords": [
        ...
        "screenwriting",
        "directing",
        "entertainment industry pipeline"
      ],
      "entry_careers": [
  ...
  "54": [
    {
      "major_label": "Marketing & Brand Strategy",
      "riasec_affinity": [
        "E",
        "A",
        "S"
      ...
      "deployment_contexts": [
        ...
        {
          "domain": "Go-to-Market Strategy & Product Launch",
          "edge": "Every product a company ships — software, a physical good, a service tier — needs someone to answer a deceptively hard question before launch: who is this for, why will they choose it, and how will they find out it exists. Go-to-market strategy sits at the intersection of marketing, sales, and product, translating what a product actually does into a real plan for reaching the customers who need it. Technology companies in particular build dedicated go-to-market and product marketing teams specifically because a great product with a poorly executed launch fails just as often as a mediocre product with a strong one — the discipline is now recognized as its own career track, not a marketing afterthought."
        },
        {
          "domain": "Sales Enablement & Revenue Marketing",
          "edge": "The handoff between marketing and sales — the moment a prospect stops reading content and starts talking to a person — is one of the most consistently mismanaged transitions in a company, and the professionals who fix it are increasingly called sales enablement or revenue marketing specialists. Their job is building the materials, messaging, and qualification criteria that let a sales team actually close what marketing generates: case studies, competitive battle cards, and the shared definition of what makes a lead worth calling. B2B software companies in particular have built out entire sales enablement functions over the past decade, recognizing that marketing generating interest and sales converting it are not automatically the same skill, and the gap between them is exactly where this role lives."
        }
      ]
    },
    {
    ...
    {
      "major_label": "Architecture (Sustainable & Biophilic Design Track)",
      "riasec_affinity": [
        "A",
        "R",
        "I"
    ...
    {
      "major_label": "Market Research & Consumer Insights",
      "riasec_affinity": [
        "I",
        "C",
        "E"
      ...
      "entry_careers": [
        ...
        "Data Analyst (Consumer Research)"
      ],
      "world_alignment": "Think",
      "cc_transfer_friendly": true,
      "emerging_role": "Consumer Data Scientist — the researcher who has moved beyond the traditional survey-and-focus-group toolkit into the statistical and computational methods that let a company understand consumer behavior at genuine scale: analyzing purchase panel data, building predictive models of what a customer will do next, and translating a dataset of millions of transactions into a recommendation a brand manager can actually act on. Nielsen and Circana (formerly IRI) built entire industries around syndicated consumer data before most companies had their own data science teams, and the analyst who combines classical market research training with real statistical and analytics fluency is positioned for work that neither a pure statistician nor a pure marketer can do alone.",
      "deployment_contexts": [
        {
          "domain": "Syndicated Research & Consumer Panels",
          "edge": "Nielsen and Circana both built their entire business models on a genuinely large-scale operation: continuously tracking what millions of real households actually buy, then selling that aggregated intelligence back to the consumer brands trying to understand their own market position. A student who works in this space isn't guessing at consumer behavior from a small sample — they're working with some of the most comprehensive real-world purchase data that exists, and learning to extract a specific, actionable insight from an ocean of transactions is a genuinely rare, valuable skill most marketing programs don't teach directly."
        },
        {
          "domain": "Advanced Analytics & Predictive Consumer Modeling",
          "edge": "The shift from asking consumers what they think they'll do to statistically modeling what they actually will do is the single biggest change in market research over the past decade — and it requires genuine quantitative rigor, not just familiarity with a survey tool. Students who pair market research coursework with real statistics or data science training are positioned for roles that traditional market research programs, built around survey design and focus group moderation, don't fully prepare graduates for on their own. This is where the discipline is actually moving, and the analyst who can build a churn model or a purchase-propensity score is doing fundamentally different work than the analyst who can only summarize a survey."
        },
        {
          "domain": "Primary Research & Survey Methodology",
          "edge": "Not every question a company needs answered already exists in a syndicated dataset — sometimes someone has to design the actual study: writing unbiased survey questions, choosing a representative sample, and knowing when a focus group will surface something a questionnaire never could. Ipsos and Kantar both run large-scale primary research operations that recruit specifically for this rigor, and the researcher who understands proper survey methodology — not just how to build a form, but how to avoid the dozen common ways a poorly designed study produces a confidently wrong answer — is doing work that directly protects a company from making expensive decisions based on bad data."
        }
      ]
    },
    {
      "major_label": "Digital Marketing & Analytics",
      "riasec_affinity": [
        "I",
        "E",
        "C"
      ...
      "world_alignment": "Systems",
      "cc_transfer_friendly": true,
      "emerging_role": "Growth & Performance Marketing Analyst — the marketer whose work is measured in real time against a number, not evaluated months later on brand perception alone: which ad drove the click, which click drove the signup, which signup actually converted to a paying customer, and what it cost to get there. Every dollar spent on Google, Meta, or programmatic advertising generates a data trail, and the analyst who can read that trail — attribution modeling, cohort analysis, customer acquisition cost against lifetime value — is doing marketing that lives or dies on evidence rather than instinct. This is the fastest-growing entry point into marketing for a student who likes the discipline's creative and psychological side but wants their work to be provably, immediately accountable.",
      "deployment_contexts": [
        {
          "domain": "Performance Marketing & Paid Media Analytics",
          "edge": "Every major consumer brand now runs paid advertising campaigns across Google, Meta, and a growing list of programmatic ad platforms, and someone has to determine whether that spend is actually working — not through intuition, but through genuine statistical analysis of click-through rates, conversion rates, and the true cost of acquiring a customer through each channel. Agencies like WPP, Omnicom, and Publicis, alongside in-house teams at nearly every direct-to-consumer brand, have built entire performance marketing functions around exactly this discipline, and the analyst who is comfortable moving between a marketing brief and a spreadsheet of campaign data is doing work that is directly, visibly tied to revenue in a way few other marketing roles are."
        },
        {
          "domain": "Marketing Technology & Automation",
          "edge": "The software stack that runs a modern marketing department — platforms like HubSpot, Salesforce Marketing Cloud, and Adobe's marketing suite — has become sophisticated enough that operating it well is its own specialized skill, distinct from writing the campaign itself. A student drawn to the systems and automation side of marketing, building the workflows that trigger the right message to the right customer at the right moment without a person manually sending each one, is looking at a genuinely technical marketing career that most people picture as purely creative work until they actually see the dashboard behind it."
        },
        {
          "domain": "SEO, Content Performance & Organic Growth",
          "edge": "Search engine optimization is frequently dismissed as a checklist of technical tricks, but at any real scale it is a genuinely analytical discipline: understanding how search algorithms evaluate relevance and authority, testing which content actually earns organic traffic, and building the kind of long-term visibility that paid advertising can't buy outright. The student who enjoys the puzzle-like, iterative nature of figuring out what actually works — not guessing, but testing and measuring — has real signal for a specialization that sits at the intersection of writing, data, and technical curiosity."
        }
      ]
    }
  ],
  ...
  "62": [
    ...
    },
    {
      ...
      "entry_careers": [
        ...
        "Skin Biology Research Associate"
      ],
      "world_alignment": "Think",
      "cc_transfer_friendly": false,
  ...
  "72": [
    ...
    },
    {
      ...
      "entry_careers": [
        ...
        "Cruise Line Operations Trainee"
      ],
      "world_alignment": "People",
      "cc_transfer_friendly": true,
  ...
  "91": [
    {
      "major_label": "Construction Management (Smart Building Systems Track)",
      "riasec_affinity": [
        "R",
        "E",
        "C"
      ...
      "deployment_contexts": [
        ...
        {
          "domain": "Sustainable Construction & Green Building",
          "edge": "LEED certification, embodied carbon accounting, and net-zero construction are no longer optional features on commercial projects — they are contractual requirements and market expectations. The construction manager who understands these standards is doing the mainstream work of the industry as it has restructured around energy performance and environmental accountability. Arizona State and Georgia Tech both have programs with direct recruiting relationships with the firms building the largest green projects in their regions."
        },
        {
          "domain": "Infrastructure & Public Works",
          "edge": "The Infrastructure Investment and Jobs Act committed more than one trillion dollars to roads, bridges, water systems, broadband, and transit. The construction professionals who manage those projects will be among the most consequential and most in-demand people in the American economy for the next decade. Penn State and Texas A&M both have documented pipelines into state DOT and federal infrastructure contracting roles."
        },
        {
          "domain": "Advanced Manufacturing Facility Construction",
          "edge": "TSMC is building two chip fabrication plants in Phoenix. Intel is building four in Ohio. Eli Lilly is building its largest pharmaceutical manufacturing facility in Indiana. Every one of these projects requires construction managers who understand cleanroom standards, vibration isolation, ultra-pure water systems, and FDA documentation requirements. Purdue and Arizona State both have students placed into the construction programs serving these facilities."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "deployment_contexts": [
        {
          "domain": "Manufacturing Operations & Continuous Improvement",
          "edge": "The American manufacturing renaissance driven by reshoring, defense investment, and the CHIPS and IRA Acts is creating demand for manufacturing operations professionals faster than the workforce can supply them. Pittsburg State University and Southern Illinois University Carbondale both have industrial technology programs with strong regional placement in manufacturing operations roles."
        },
        {
          "domain": "Defense Manufacturing & Quality Assurance",
          "edge": "Every weapons system and piece of defense electronics the United States procures is manufactured to specifications governed by a quality system more rigorous than almost any civilian industry. The manufacturing professional who understands AS9100 aerospace standards, ITAR compliance, and defense procurement documentation is building toward a career inside one of the most stable and well-compensated industrial sectors in the economy."
        }
      ]
    },
    {
      "major_label": "HVAC/R Technology",
      "riasec_affinity": [
        "R",
        "I",
        "C"
      ...
      "emerging_role": "Building Automation & Smart HVAC Commissioning Specialist — the technician who commissions intelligent HVAC, lighting, and security systems as buildings converge with IoT and energy-efficiency mandates. Physical installation, system calibration, and on-site troubleshooting require human presence and judgment that no remote team can replicate — the person who makes an intelligent building actually work is doing something genuinely irreplaceable.",
      "deployment_contexts": [
        {
          "domain": "Smart Building Commissioning",
          "edge": "Commissioning an intelligent HVAC system means fluency in BACnet and Modbus building automation protocols, energy management systems, and the OSHA-certified physical work of actually installing and calibrating the equipment. This is not a trades job with a technology veneer — it is a genuinely hybrid role, and the technician who develops both halves of it is positioned for work that neither a pure electrician nor a pure software person can do alone."
        },
        {
          "domain": "Refrigeration & Regulated Energy Systems",
          "edge": "Anyone who handles refrigerants is federally required to hold EPA Section 608 certification — a real licensing floor that structurally limits supply and protects wages in a way many trades do not have. The student drawn to hands-on technical work with a genuine regulatory credential behind it, not just a certificate of completion, has real signal for this specific track."
        }
      ]
    },
    {
      "major_label": "Building Automation & Smart Systems",
      "riasec_affinity": [
        "R",
        "I",
        "C"
      ...
      "emerging_role": "Building Systems Integrator — the professional who sits above individual trades (electrical, HVAC, security) and makes sure their systems actually talk to each other, programming and integrating the automation layer that ties a modern commercial building together. This is the clearest example of the cluster's core thesis: the trades never left, but a real layer of systems intelligence now sits on top of them, and the person who can operate at both levels is doing genuinely new work, not an old job with a new label.",
      "deployment_contexts": [
        {
          "domain": "Commercial Systems Integration",
          "edge": "A modern commercial building runs HVAC, lighting, security, and energy management as separate systems that need to be integrated and programmed to work together — a discipline distinct from installing any single one of them. The student who likes both the physical, tangible side of building systems and the logic of programming how they interact is looking at a role most people never realize exists inside \"the trades.\""
        },
        {
          "domain": "Energy Efficiency & IoT Convergence",
          "edge": "Energy efficiency mandates and the maturation of IoT sensor technology are pushing every new commercial and large residential building toward automated, sensor-driven systems — and the installed base of buildings still running on manual controls is enormous. The technician who can retrofit older buildings with modern automation, not just install it new, has a genuinely large and durable market."
        }
      ]
    },
    {
      "major_label": "Robotics & Automation Technology",
      "riasec_affinity": [
        "R",
        "I",
        "C"
      ...
      "emerging_role": "Precision Manufacturing & Robotics Technician — the skilled operator who sets up, programs, and maintains the CNC machines and industrial robots that reshoring, chip fabrication expansion, and defense supply chain growth are driving demand for right now. American manufacturing runs on the people who can read a blueprint and hold a tolerance of a thousandth of an inch — machine setup, quality control, and process optimization require exactly the kind of skilled human judgment at every step that full automation still cannot replace.",
      "deployment_contexts": [
        {
          "domain": "Precision CNC Manufacturing",
          "edge": "Aerospace, medical device, and defense-adjacent manufacturers all depend on technicians who can program and operate CNC equipment to extremely tight tolerances — this is precise, high-consequence work where a mistake is measured in thousandths of an inch, not a loose or approximate trade. The student who is drawn to exact, technical craftsmanship with real physical stakes has genuine signal for this track."
        },
        {
          "domain": "Industrial Robotics Integration",
          "edge": "As warehouses and factories increasingly deploy robotic systems for material handling and production, the technicians who can install, program, and troubleshoot those robots — not just operate the line around them — are becoming as essential as the robots themselves. This is the trades' own version of the systems-fluency layer the whole Intelligent Trades cluster is built around."
        }
      ]
    }
  ],
  ...
  "93": [
    ...
    },
    {
      ...
      "world_alignment": "People",
      "cc_transfer_friendly": true,
      "emerging_role": "Frontline-to-Senior Leadership Pipeline — the specific, learnable craft of managing people, distinct from the broader business literacy that Business Administration teaches. Nearly every senior leader's career started with managing three to eight direct reports somewhere unglamorous — a retail floor, a warehouse shift, a restaurant. The student who wants to lead people specifically, not just understand how a business runs, is training for the skill that determines whether an organization's frontline actually works.",
      "deployment_contexts": [
        {
          "domain": "Frontline & First-Line Supervision",
          "edge": "Most people's first real leadership experience is supervising a small team in a retail, hospitality, warehouse, or service environment — and organizations consistently struggle to find people who are actually good at this specific, undervalued job. The student who has already been the one who naturally organizes the group project or keeps a team moving when things stall has real evidence of the exact skill this career path is built on."
        },
        {
          "domain": "Management as a Craft, Not Just a Title",
          "edge": "Giving useful feedback, running a meeting that ends with clear next steps, and handling conflict between two team members without making it worse are learnable, specific skills — not a personality trait some people are just born with. Poor management is one of the most consistently cited drivers of employee turnover across industries, which means the student who takes management seriously as a craft to develop, rather than a title to earn, is building toward one of the most structurally undersupplied skills in the American workplace."
        }
      ]
    },
    {
      "major_label": "Supply Chain Management (People-Facing Ops Track)",
      "riasec_affinity": [
        "E",
        "C",
        "S"
      ...
      "world_alignment": "Systems",
      "cc_transfer_friendly": true,
      "emerging_role": "Supply Chain Relationship Manager — distinct from the physical-logistics side of supply chain (warehousing, transportation, freight movement), this is the person who manages the human relationships that make a supply chain actually function: negotiating with suppliers, coordinating between procurement, manufacturing, and sales, and managing the fallout when a shipment does not arrive on time. The technical optimization of supply chains is increasingly automated and software-driven; the relationship and judgment layer that holds it together under real-world disruption is not.",
      "deployment_contexts": [
        {
          "domain": "Supplier & Vendor Relationship Management",
          "edge": "The person who negotiates supplier contracts, manages vendor performance over time, and resolves the conflict when a supplier fails to deliver is doing a job that is fundamentally about trust and communication as much as it is about spreadsheets and purchase orders. The student who is a natural coordinator — who reads people well and stays calm when a plan falls apart — has real signal for this specific supply chain track, distinct from the purely analytical logistics-optimization side of the field."
        },
        {
          "domain": "Cross-Functional Supply Chain Coordination",
          "edge": "Widespread supply chain disruption in recent years pushed many organizations to create roles whose entire job is sitting between procurement, manufacturing, and customer-facing teams to keep everyone aligned when something breaks. This is orchestration work in its purest form — no single function owns the problem, and the person who can hold the whole picture together across teams that do not naturally talk to each other is doing some of the most structurally necessary work in a modern supply chain."
        }
      ]
    }
  ],
  "94": [
    {
      "major_label": "Finance (Search Fund & Acquisition Track)",
      "riasec_affinity": [
        "E",
        "I",
        "C"
    ...
    {
      "major_label": "Economics (Market Intelligence & Deal Analysis Track)",
      "riasec_affinity": [
        "I",
        "E",
        "C"
    ...
    {
      "major_label": "Accounting (Transaction Advisory Track)",
      "riasec_affinity": [
        "C",
        "E",
        "I"
    ...
    {
      "major_label": "Real Estate (PropTech Investment Track)",
      "riasec_affinity": [
        "E",
        "I",
        "C"
    ...
    {
      "major_label": "Business Administration (PE Portfolio Operations Track)",
      "riasec_affinity": [
        "E",
        "C",
        "I"
      ...
      "entry_careers": [
        "Business Development Associate",
        "Strategy Analyst",
        "Operations Associate at PE-backed company",
        "Management Trainee"
      ],
      "world_alignment": "Systems",
      "cc_transfer_friendly": true,
    ...
    },
    {
      ...
      "entry_careers": [
        "Agribusiness Analyst",
        "Farm Management Associate",
        "Agricultural Equipment Dealer Associate",
        "Rural Roll-Up Operations Analyst"
      ],
      "emerging_role": "Agricultural Roll-Up Operator — the professional who applies private equity consolidation strategy to fragmented rural industries: veterinary practice networks, farm equipment dealerships, grain elevators, and agricultural service companies. Rural America is full of small, profitable, family-owned businesses with no succession plan, and the student who genuinely understands both agriculture and deal-making is positioned for one of the least-competed-for versions of the roll-up strategy — most finance and PE talent clusters in cities, leaving rural roll-ups relatively underserved by comparison.",
      "deployment_contexts": [
        {
          "domain": "Veterinary & Agricultural Services Roll-Ups",
          "edge": "Veterinary practice consolidation is one of the most active roll-up categories in the current private equity landscape — small, independently-owned clinics being acquired and folded into larger networks. The student who combines genuine agricultural or animal-industry knowledge with deal fluency is unusually positioned for this specific version of the roll-up thesis, which requires industry credibility that a generic finance background does not provide on its own."
        },
        {
          "domain": "Farm Equipment & Grain Operations Consolidation",
          "edge": "Equipment dealerships, grain elevators, and agricultural service companies are classically fragmented rural industries — many family-owned, many without a clear succession plan, many ripe for the exact consolidation strategy this cluster is built around. The student who is drawn to both the deal-making thesis and to agriculture specifically, rather than viewing agriculture as a fallback, has real signal for a genuinely underserved version of this career path."
        }
      ]
    },
    {
      "major_label": "Industrial Distribution",
      "riasec_affinity": [
        "E",
        "C",
        "R"
      ...
      "entry_careers": [
        "Industrial Distribution Analyst",
        "Operations Associate",
        "Supply Chain & Deal Flow Analyst",
        "Distribution Operations Manager"
      ],
      "emerging_role": "Operator-Dealmaker — the professional who combines real operational fluency, understanding how a distribution business actually runs day to day, with the ability to evaluate and execute an acquisition. This is exactly the \"operator-plus-dealmaker\" profile the roll-up economy runs on. Most finance students understand deal structure without ever having run day-to-day operations; most operations students never learn deal structure. The student who builds real competence in both is rare, and rare is exactly what makes this profile valuable to PE-backed roll-ups that need someone who can actually run what they just bought, not just structure the purchase.",
      "deployment_contexts": [
        {
          "domain": "Post-Acquisition Operations Integration",
          "edge": "After a private equity firm acquires a distribution business, someone has to actually integrate it, run it, and make the operational improvements that justify the purchase price — this is a distinct, real job function, often called an operating partner or portfolio operations role, and it requires operational literacy that a pure deal-structuring background does not provide. The student who is drawn to understanding how a business actually functions, not just how to finance buying one, has genuine signal for this specific track."
        },
        {
          "domain": "Industrial & Wholesale Distribution Consolidation",
          "edge": "Distribution is one of the most fragmented, most actively consolidated sectors in the American economy — thin margins and real scale advantages make roll-up strategy especially effective here. The student who is fascinated by the logistics and operations side of how goods actually move, combined with genuine interest in how deals get made, is looking at one of the more concrete, tangible entry points into the acquisition economy."
        }
      ]
    },
    {
      "major_label": "Mathematics (Deal Modeling Track)",
      "riasec_affinity": [
        "I",
        "C",
        "R"
      ...
      "entry_careers": [
        "Quantitative Analyst",
        "Deal Modeling Associate",
        "Financial Analyst (Quant Track)",
        "Valuation Analyst"
      ],
      "emerging_role": "Deal Quant — the person who builds the actual financial models that determine whether a deal makes sense: cash flow projections, valuation multiples, leverage scenarios, sensitivity analysis. Every acquisition ultimately runs through a spreadsheet built by someone genuinely fluent in the underlying mathematics, not just comfortable using a calculator. The mathematics major who develops real financial modeling skill on top of a rigorous quantitative foundation is often better equipped for this specific work than a finance major whose math training was comparatively shallow.",
      "deployment_contexts": [
        {
          "domain": "Deal Modeling & Valuation",
          "edge": "Building a defensible valuation model — one that survives real scrutiny from investors, lenders, and the seller's own advisors — requires genuine mathematical rigor, not just familiarity with a template. The student who likes math for its own sake, who enjoys the precision and the proof of it, and who can see how that rigor applies directly to a real business decision with real money at stake, has strong signal for this track."
        },
        {
          "domain": "Quantitative Risk & Leverage Analysis",
          "edge": "Acquisitions are frequently financed with significant debt, and understanding the mathematics of leverage, downside scenarios, and risk sensitivity is what separates a deal that is smart from one that is reckless. The mathematically rigorous student who wants their quantitative skill to matter in a room where real decisions get made, not just in an abstract academic exercise, is well suited to this specific, high-stakes application of the discipline."
        }
      ]
    }
  ],
  "95": [
    {
      ...
      "entry_careers": [
        ...
        "Pre-Med Graduate",
        "Research Associate in Aging Biology",
        "Longevity Clinic Associate"
      ],
      "world_alignment": "Think",
      "cc_transfer_friendly": false,
    ...
    {
      "major_label": "Public Health (Longevity & Aging Track)",
      "riasec_affinity": [
        "I",
        "S",
        "E"
    ...
    {
      "major_label": "Health Administration",
      "riasec_affinity": [
        "E",
        "S",
        "C"
      ...
      "world_alignment": "Systems",
      "cc_transfer_friendly": true,
      "emerging_role": "Senior Living Operations Executive — the licensed administrator who runs the business, regulatory, and financial side of assisted living communities, memory care facilities, and continuing care retirement communities (CCRCs). Every U.S. state requires a licensed Nursing Home Administrator to run a skilled nursing facility, and the same demographic wave driving demand for senior housing units is driving demand for the licensed professionals who can legally and competently operate them. This is a career where the credential itself is the bottleneck, not the interest.",
      "deployment_contexts": [
        {
          "domain": "CCRC & Senior Living Operations",
          "edge": "Continuing care retirement communities combine independent living, assisted living, memory care, and skilled nursing under one operator — which means the administrator has to be fluent in real estate, healthcare regulation, hospitality operations, and elder care simultaneously. The student who is drawn to running something complex, with real financial and regulatory stakes, and who also cares about the people the operation serves, is building toward one of the most structurally guaranteed leadership pipelines in the aging economy — the licensure requirement itself limits supply in a way few other administrative careers do."
        },
        {
          "domain": "Healthcare Systems & Value-Based Aging Care",
          "edge": "As Medicare Advantage plans and value-based care contracts increasingly reward health systems for keeping older patients healthy rather than just treating them when sick, health administrators who understand population health strategy for aging patients specifically — not healthcare administration in general — are becoming the professionals who design how a hospital system actually serves its oldest and most complex patients well."
        }
      ]
    },
    {
      "major_label": "Communication Disorders",
      "riasec_affinity": [
        "S",
        "I",
        "A"
      ...
      "entry_careers": [
        ...
        "SLP Graduate Student (pre-clinical pathway)",
        "Audiology Assistant"
      ],
      "world_alignment": "People",
      "cc_transfer_friendly": false,
      "emerging_role": "Geriatric Speech-Language Pathologist — the clinician who treats the two communication and swallowing problems that become common with age: dysphagia (swallowing disorders, often following a stroke, that carry real aspiration-pneumonia risk) and cognitive-communication decline associated with dementia and aphasia. The American Speech-Language-Hearing Association has documented a long-standing workforce shortage in skilled nursing and long-term care settings specifically — this is one of the aging-economy careers where the demand is already outstripping supply, not a projection.",
      "deployment_contexts": [
        {
          "domain": "Dysphagia & Swallowing Rehabilitation",
          "edge": "Swallowing disorders are one of the most common and most dangerous consequences of stroke and advanced dementia — aspiration pneumonia from an undiagnosed or poorly managed swallowing disorder is a leading cause of hospitalization and death in frail older adults. The student who is drawn to precise, hands-on clinical work with immediate, measurable impact on someone's safety is looking at one of the most concretely life-saving specialties within speech-language pathology."
        },
        {
          "domain": "Cognitive-Communication & Dementia Care",
          "edge": "As dementia progresses, the ability to find words, follow conversation, and communicate needs erodes before other cognitive functions — and speech-language pathologists are increasingly the clinicians who help families and care teams understand what a person with dementia can still communicate and how to reach them. This is relationship-intensive clinical work at the exact intersection of science and human connection that draws students to this field in the first place."
        }
      ]
    },
    {
      "major_label": "Computer Science (Aging & Accessible Technology Track)",
      "riasec_affinity": [
        "I",
        "R",
        "C"
      ...
      "world_alignment": "Systems",
      "cc_transfer_friendly": true,
      "emerging_role": "Accessible Technology / Aging Tech Engineer — software engineers who build telehealth platforms, fall-detection sensors, medication-adherence apps, and voice-interface tools designed specifically for older-adult usability, not retrofitted from products built for 25-year-olds. Most consumer software is designed by and for a young, high-dexterity, high-vision user by default; the engineer who deliberately designs for reduced vision, reduced dexterity, and different cognitive load patterns is solving a real, underbuilt problem rather than a hypothetical one.",
      "deployment_contexts": [
        {
          "domain": "Telehealth & Remote Monitoring Systems",
          "edge": "Remote patient monitoring — wearables and home sensors that track falls, medication adherence, vital signs, and activity patterns for aging adults living independently — is one of the fastest-growing categories in health technology, precisely because it lets people stay in their own homes longer, which is what most older adults actually want. Rochester, Minnesota, built around the Mayo Clinic's own research infrastructure, is one of the real concentration points for this exact intersection of clinical medicine and health technology development, alongside the Bay Area's broader health-tech ecosystem. The computer science student who builds toward this space is combining real technical depth with a genuinely high-stakes, high-meaning application."
        },
        {
          "domain": "Accessible Interface Design for Aging Users",
          "edge": "Designing an interface that a 78-year-old with reduced fine motor control and declining near vision can actually use — without feeling condescending or clinical — is one of the harder, more underrated problems in software design. The engineer who takes this seriously as a technical and design discipline, not an afterthought accessibility checkbox, is positioned for a career at the center of where technology and the aging economy actually meet."
        }
      ]
    }
  ],
  "96": [
    ...
    },
    {
      ...
      "entry_careers": [
        "Estate Planning Attorney Associate",
        "Trust & Estate Law Clerk",
        "Elder Law Associate",
    ...
    {
      "major_label": "Nonprofit Management",
      "riasec_affinity": [
        "S",
        "E",
        "C"
      ...
      "world_alignment": "People",
      "cc_transfer_friendly": true,
      "emerging_role": "Philanthropic Strategist — the professional who helps wealthy families translate values into structured giving: setting up family foundations, donor-advised funds, and planned-giving strategies that are every bit as deliberate as the estate planning that funds them. Donor-advised funds are one of the fastest-growing charitable vehicles in the country, and a growing share of the ongoing wealth transfer is explicitly earmarked for philanthropy — families increasingly want their giving to be strategic, not just generous, and someone has to design that strategy.",
      "deployment_contexts": [
        {
          "domain": "Family Foundation & Donor-Advised Fund Strategy",
          "edge": "A family that wants to give away meaningful wealth over generations needs the same kind of structured thinking that goes into any other part of estate planning — which causes to fund, how much control to retain, how to involve the next generation in giving decisions. The professional who helps design that structure is doing work that sits at the exact intersection of finance, family dynamics, and mission — precisely the blend this cluster is built around."
        },
        {
          "domain": "Planned & Legacy Giving",
          "edge": "Nonprofits increasingly employ dedicated planned-giving officers whose entire job is working alongside a donor's estate attorney and financial planner to structure a bequest that serves both the family's wishes and the organization's needs. This role literally sits inside the same conversations as trust officers and fiduciary advisors — it is Legacy Economy work from the receiving side of the transfer, not just the giving side."
        }
      ]
    },
    {
      "major_label": "Psychology (Wealth & Family Dynamics Track)",
      "riasec_affinity": [
        "S",
        "I",
        "A"
      ...
      "world_alignment": "People",
      "cc_transfer_friendly": true,
      "emerging_role": "Family Wealth Psychologist — the professional who understands that managing a family's legacy is as much about navigating family dynamics, conflict, and identity as it is about managing money. Inheritance and wealth transitions are a well-documented source of family conflict, and the advisor who understands the human layer beneath the financial one — not just the numbers, but what the money means to the people involved — becomes the trusted advisor a family keeps for generations rather than the one they replace after the first disagreement.",
      "deployment_contexts": [
        {
          "domain": "Family Wealth Psychology & Conflict Navigation",
          "edge": "Sibling conflict over inheritance, the psychological weight of sudden or inherited wealth, and the gap between what a family says it wants and what it actually does with money are real, recurring patterns in wealth management — patterns that a purely financial advisor is not trained to see coming or navigate when they surface. Family offices increasingly bring in psychology-trained staff specifically because the money problems are rarely just money problems."
        },
        {
          "domain": "Behavioral Finance in Wealth Advisory",
          "edge": "Behavioral finance — the study of how real people actually make financial decisions, as opposed to how a textbook says a rational actor would — is directly applicable to high-net-worth family decision-making, where emotion, legacy, and identity are woven into every major financial choice. The student who is genuinely curious about why people make the financial decisions they do, not just what the optimal decision would be, has real signal for this track."
        }
      ]
    }
  ],
  "100": [
    {
      "major_label": "Strategic Intelligence",
      "riasec_affinity": [
        "I",
        "E",
        "S"
      ...
      "entry_careers": [
        ...
        "Security Studies Research Associate",
        "Geopolitical Risk Analyst",
        "Intelligence Community Associate"
      ],
      "world_alignment": "Think",
      "cc_transfer_friendly": false,
      "emerging_role": "Intelligence Community Analyst — the veteran who translates operational or tactical intelligence experience gained in service into the formal analytical tradecraft of the civilian intelligence community: assessing threats, synthesizing raw information into decision-grade assessments, and briefing decision-makers on findings that matter. This is one of the most specific and most undersurfaced majors available to an intelligence-community-bound veteran — most civilian counselors have never heard of the programs built specifically for this path.",
      "deployment_contexts": [
        {
          "domain": "Intelligence Community Career Pathways",
          "edge": "A veteran with an active security clearance and real intelligence, operations, or analytical experience is immediately hire-eligible for roles that take civilian candidates 12-18 months and significant cost to clear. The Washington DC metro area remains the real geographic center of this career path — the density of agencies, contractors, and cleared-workforce infrastructure there has no real equivalent elsewhere in the country. Strategic Intelligence as a formal major gives that operational background an academic and credentialing structure that intelligence agencies and contractors specifically recruit against."
        },
        {
          "domain": "Strategic Intelligence Academic Programs",
          "edge": "The National Intelligence University, Georgetown's security studies programs, and American University's School of International Service all offer Strategic Intelligence or closely-aligned degree paths built specifically for students headed toward the intelligence community — programs that almost never appear on a traditional high school counselor's radar, despite being some of the most direct and highest-placement pathways into national security careers that exist."
        }
      ]
    },
    {
      "major_label": "Emergency Management",
      "riasec_affinity": [
        "R",
        "E",
        "S"
      ...
      "entry_careers": [
        ...
        "Incident Command Associate"
      ],
      "emerging_role": "Emergency Management / Corporate Resilience Director — the most direct civilian translation available for an operations-oriented veteran, taking the exact skill set built in military logistics, crisis response, and operating under pressure with incomplete information and applying it to disaster response, FEMA and state emergency management, or corporate business continuity planning. The operational muscle memory transfers almost without translation.",
      "deployment_contexts": [
        {
          "domain": "FEMA & State Emergency Management",
          "edge": "Federal and state emergency management agencies actively recruit veterans specifically because the operational overlap is so direct — planning for and executing a coordinated response under real time pressure and real stakes is close to identical whether the context is a deployment or a disaster. The veteran who studies emergency management formally is adding a credential to a skill set the agency already trusts them to have."
        },
        {
          "domain": "Corporate Business Continuity & Resilience",
          "edge": "As companies increasingly build dedicated resilience and business-continuity functions in response to climate disruption, supply chain shocks, and operational risk generally, the veteran who understands how to plan for and operate through crisis is one of the most directly qualified hires available — this is a fast-growing corporate function that most students, veteran or not, have never heard named as a career path."
        }
      ]
    },
    {
      "major_label": "Data Analytics & Operations",
      "riasec_affinity": [
        "I",
        "C",
        "E"
      ...
      "entry_careers": [
        ...
        "Logistics Analytics Associate",
        "Operations Research Analyst"
      ],
      "emerging_role": "Operations Analyst — the veteran who combines real operational experience with analytical training is one of the most valuable profiles in defense contracting and government service, because most analysts have the data skills without ever having actually run the operation they are analyzing, and most operators have the operational judgment without the formal analytical toolkit to quantify and optimize it. Combining both is rare and specifically sought after.",
      "deployment_contexts": [
        {
          "domain": "Defense Contractor Operations Analytics",
          "edge": "Major defense contractors specifically look for the combination of operational military experience and analytical training when hiring for logistics optimization, program analysis, and operations research roles — a veteran who has actually managed equipment, personnel, or supply chains in the field brings a grounded understanding of what the data actually represents that a purely academic analyst cannot replicate."
        },
        {
          "domain": "Government & Federal Data Analytics",
          "edge": "Federal agencies increasingly hire directly into data and logistics analyst roles where the ability to understand real operational constraints — not just run the numbers — determines whether an analysis is actually usable. The veteran with formal data analytics training and real operational background is positioned for exactly this kind of role from day one, without the multi-year learning curve a purely academic hire would need."
        }
      ]
    }
  ]
